(function() {
  ...
  $(function() {
    var bytecode, defaultBytecode, emulator,
      _this = this;
    ...
    Gt.onStart = function(ship) {
      ...
      return emulator.runAsync();
    };
    Gt.onStop = function() {
      return emulator.paused = true;
    };
    Gt.onStep = function() {
      var device, i, _i, _len, _ref, _results;
      if (!emulator.paused) {
        _ref = emulator.devices;
        _results = [];
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
          device = _ref[i];
          if (device.step != null) {
            _results.push(device.step());
          } else {
    ...
    new TagC.BytecodeLoader($('#bytecode-load').get(0), defaultBytecode, function(_bytecode) {
      bytecode = _bytecode;
...
(function() {
  var AiPlayer, Bullet, BulletTrail, CommandCentre, Controller, Gt, LocalPlayer, Mass, MassDriver, MassStorage, Player, PlayerStorage, Ship, ShipTrail, Star, Starfield, Turret, TurretBullet, Universe, Vector, Viewpoint, WeaponsFire, _ref,
  ...
  Controller = (function() {
    ...
    Controller.prototype.setupCanvas = function() {
      ...
      return $(document).resize(function() {
        var _ref1;
        return _ref1 = [$(window).width() - 5, $(window).height() - 5], _this.canvas.width = _ref1[0], _this.canvas.height = _ref1[1], _ref1;
      });
    };
  ...
  TurretBullet = (function(_super) {
    ...
    function TurretBullet() {
      _ref = TurretBullet.__super__.constructor.apply(this, arguments);
      return _ref;
    }
  ...
  Viewpoint = (function() {
    ...
    function Viewpoint(canvas) {
      ...
      _ref1 = [canvas.width, canvas.height], this.width = _ref1[0], this.height = _ref1[1];
  ...
  Vector = (function() {
    ...
    Vector._new = function(x, y) {
      var _ref1;
      _ref1 = y != null ? [x, y] : [Math.cos(x), Math.sin(x)], x = _ref1[0], y = _ref1[1];
      x || (x = 0);
      y || (y = 0);
  ...
  BytecodeLoader = (function() {
    ...
    BytecodeLoader.prototype.loadFromFile = function() {
      ...
      reader.onload = function() {
        ...
        return _this.callback(bytecode);
      };
      return reader.readAsBinaryString(this.element.files[0]);
    };
...
(function() {
  ...
  Thrusters = (function() {
    ...
    Thrusters.prototype.init = function() {
      return this.state = 0x0000;
    };

    Thrusters.prototype.interrupt = function() {
      var code;
      code = this.emulator.Registers.A.get();
      switch (code) {
        case 0:
          return this.emulator.Registers.B.set(this.state);
        case 1:
          return this.state = this.emulator.Registers.B.get();
      }
    };

    Thrusters.prototype.step = function() {
      switch (this.state >>> 8) {
        case 0x0f:
          this.ship.backward();
          break;
